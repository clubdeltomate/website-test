  ...
  return (
    ...
    >
      <Link
        ...
        className={cn(
          'group relative flex h-full flex-col bg-paper-3 p-5 no-underline shadow-offset',
      ...
      >
        ...
        {/* title + slug */}
        {/* Exactly two rows, always: long titles cut off with … and short
            ones still reserve the space, so every card in a row lines up. */}
        <h3
          className="mt-3 line-clamp-2 min-h-[2.75em] font-heading text-lg font-semibold leading-snug text-ink"
          title={repo.title}
        >
          {repo.title}
        </h3>
